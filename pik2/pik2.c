...
/* A structure that contains a string that would be used for the student's name, 

an integer which would be used for the student's student number

and an array of floating points which would be used for the student's marks, 

an integer for the number of grades introduced for each student,
...
void insertNewStudent(struct node **head);



void removeName(struct node **head);
...
void addMarkName(struct node **head);



void addMarkStdNumber(struct node **head);



void printListName(struct node **head);
...
// Function to insert new student in Linked list in alphabetical order

void insertNewStudent(struct node** head)

{

	char wantedName[NAMELEN]; //String to store the name of the new student when a new student is introduced
	...
	int wantedfirmNumber; // Integer to store the firm number of the new student when a new student is introduced
    ...
    //We copy the name and student number parameters into the name and student number of the student
 ...
 printf("Enter date (yy.dd.mm) format: ");
    ...
    //Looping through the students until the name of the current is alphabetically 'higher' then the one we want to insert
...
//Function to delete student from the list using the student's student number

void removeStdNumber(struct node **head){

  

  int wantedStudentNumber; //Integer to store the student number of the student that the user wished to delete
...
// Function to print report for one student using students name

void update_info(struct node **head){

  

  char wantedName[NAMELEN]; //Integer to store the name of the student whose report we wish to print
...
char wantedName1[NAMELEN]; //String to store the name of the new student when a new student is introduced
...
// Function to print report for one student using student number

void printListStdNumber(struct node **head){

  

    int wantedFirmNumber; // Integer to store student number of student whose report the user wihes to print
